    ...
    <div class="px-4 py-6 sm:px-0">
        ...
        <div class="flex items-center justify-between mb-6">
          <div>
            ...
            <p class="text-gray-600">Create a new tenant in your portfolio</p>
          </div>
...
const availableUnits = computed(() => {
  ...
  return units.value.filter(unit => {
    ...
    return unitPropertyId === form.propertyId && unit.occupancyStatus === 'Vacant'
  })
})
...
const handleSubmit = async () => {
  try {
    ...
    // Prepare the data to match the expected API structure
    const tenantData = {
      personalInfo: {
